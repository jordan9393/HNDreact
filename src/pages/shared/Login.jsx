...
const Login = () => {
    return(
        ...
        <div className="lg:flex w-1/2 hidden bg-500 bg-no-repeat bg-cover relative items-center">
            <div className="w-full px-24 z-10">
                <h1 className="text-5xl font-bold text-left tracking-wide color-red">Keep it special</h1>
            ...
            <div className="w-full py-6 z-20">
                ...
                <form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    <div className="pb-2 pt-4">
                        <input type="email" name="email" id="email" placeholder="Email" className="block w-full p-4 text-lg rounded-sm bg-white"></input>
                    </div>
                    <div className="pb-2 pt-4">

...
<div className="register-form">
        ...
        <div className="lg:flex w-1/2 hidden bg-non photo blue-500 bg-no-repeat bg-cover relative items-center">
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
            <div className="absolute lg:hidden z-10 inset-0 bg-non photo blue-500 bg-no-repeat bg-cover items-center" >
            ...
            <div className="w-full py-6 z-20">
                ...
                <form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    <div class="pb-2 pt-4">
                        <input type="email" name="email" id="email" placeholder="Email" class="block w-full p-4 text-lg rounded-sm bg-white"></input>
                    </div>
                    <div class="pb-2 pt-4">
                        <input className="block w-full p-4 text-lg rounded-sm bg-white" type="password" name="password" id="password" placeholder="Password"></input>
                    </div>
                    <div class="text-right text-gray-400 hover:underline hover:text-gray-100">
                        <a href="#">Forgot your password?</a>
                    </div>
                    <div class="px-4 pb-2 pt-4">
                        <button className="uppercase block w-full p-4 text-lg rounded-full bg-white-500 hover:bg-indigo-600 focus:outline-none">sign in</button>
                    </div>
